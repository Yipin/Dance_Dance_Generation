...
class mula_hg_based_network(nn.Module):
    ...
    def forward(self, x):
        ...
        for i in range(self.stage_num_of_encoder):
            ...
            pose_pred_list.append(pose_feat)
            parsing_pred_list.append(parsing_feat)
...
def MuLA_HG_MSRAInit(stage_num_of_encoder=1, module_num_of_pose_encoder=1, num_of_joint=16, module_num_of_parsing_encoder=1, num_of_part=20, num_of_feat=256):
